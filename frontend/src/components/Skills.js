    ...
    return (
        <div className='all-skills' id="skills">
            ...
            <div className='skill-box' >
                ...
                <i class="devicon-bootstrap-plain-wordmark colored" data-speed='4'></i>
                <i class="devicon-express-original-wordmark colored"></i>
                <i class="devicon-github-plain-wordmark colored" data-speed='-9'></i>
                <i class="devicon-python-plain-wordmark colored" data-speed='6'></i>
                <svg viewBox="0 0 128 128" data-speed='-7' className="svg-redux">
                ...
                <img alt='sql-logo' src='/sql.svg' className="svg-sql"/>
                <i class="devicon-visualstudio-plain vscode_i"></i>
            </div>
        </div>
    );
}
