    ...
    return (
        <div style={{height: '100vh', textAlign: 'center', backgroundColor: 'white'}} id="skills">
            ...
            <div className='skill-box'>
                ...
                <i class="devicon-ruby-plain-wordmark colored" style={{fontSize: '100px'}}></i>
                ...
                <i class="devicon-python-plain-wordmark colored" style={{fontSize: '100px'}}></i>
                <div style={{width: '100px', height: '100px', marginRight: '100px'}}>
