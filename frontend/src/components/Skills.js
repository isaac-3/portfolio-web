...
const Skills = () => {
    return (
        <div style={{height: '100vh', textAlign: 'center', backgroundColor: 'white'}} id="skills">
            <div style={{paddingTop: '72px'}}>
                <h1>My Skills:</h1>
            </div>
            <i class="devicon-rails-plain-wordmark colored" style={{fontSize: '100px'}}></i>
            <i class="devicon-javascript-plain colored" style={{fontSize: '100px'}}></i>
            <i class="devicon-html5-plain-wordmark colored" style={{fontSize: '100px'}}></i>
            <i class="devicon-css3-plain-wordmark colored" style={{fontSize: '100px'}}></i>
            <i class="devicon-react-original-wordmark colored" style={{fontSize: '100px'}}></i>
            ...
            <i class="devicon-bootstrap-plain-wordmark colored" style={{fontSize: '100px'}}></i>
            <i class="devicon-github-plain-wordmark colored" style={{fontSize: '100px'}}></i>
        </div>
    );
}
