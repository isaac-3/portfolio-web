    ...
    return (
        <div className='footer'>
            <div className='footer-sec'>
                <i className="fa fa-github" id='footer-github'onClick={()=>window.open("https://github.com/isaac-3")}></i>
                ...
                <i className="fa fa-linkedin-square" id='footer-linkedin' onClick={()=>window.open("https://www.linkedin.com/in/isaac-c0/")}></i>
